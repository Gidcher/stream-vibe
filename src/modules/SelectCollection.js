...
class Select extends BaseComponent {
  ...
  allyAttributes = { activeDescendant: 'aria-activedescendant' }
  ...
  updateUI() {
    ...
    const updateButton = () => {
      ...
      this.buttonElement.setAttribute(
        this.allyAttributes.activeDescendant,
  ...
  onMobileMatchMediaChange = (event) => {
    this.toggleAllyVisibility (event.matches)
  }
  ...
  onArrowDownKeyDown = () => {
    ...
    if (this.state.currentOptionIndex < this.optionElements.length) {
      this.state.currentOptionIndex++
    }
  }
